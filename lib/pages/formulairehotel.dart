    ...
    if (_formKey.currentState!.validate()) {
      ...
      builder: 
       (_) => AlertDialog(
              ...
              content: const Text("Votre hotel a ete ajouté avec succès !"),
           actions: [
      TextButton(
        onPressed: () {
          Navigator.of(context).pop(); // Fermer le dialogue
          Navigator.of(context).pop(hotelData); // Retourner les données
        },
        child: const Text("OK"),
      ),
    ],
          ...
          child: Column(
            children: [
              TextFormField(
                ...
                validator:
                    (v) => v!.isEmpty ? 'Entrez le nom de l\'hôtel' : null,
              ),
              const SizedBox(height: 10),
              TextFormField(
              ...
              TextFormField(
                ...
                validator:
                    (v) => v!.isEmpty ? 'Entrez le numéro de téléphone' : null,
              ),
              const SizedBox(height: 10),
              TextFormField(
              ...
              //   decoration: const InputDecoration(labelText: 'Prix moyen (F CFA)', border: OutlineInputBorder()),
              ...
              ElevatedButton(
                onPressed: _submit,
                child: const Text("Ajouter votre hôtel"),
              ),
            ],
          ),
        ),
